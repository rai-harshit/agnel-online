...
class MemCache extends Cache
{
    ...
    public $options;
    /**
     * @var string memcached sasl roll_no. This property is used only when [[useMemcached]] is true.
    ...
    public function getMemcache()
    {
        if ($this->_cache === null) {
            ...
            if ($this->useMemcached) {
                ...
                if ($this->roll_no !== null || $this->password !== null) {
                    $this->_cache->setOption(\Memcached::OPT_BINARY_PROTOCOL, true);
                    $this->_cache->setSaslAuthData($this->roll_no, $this->password);
                }
