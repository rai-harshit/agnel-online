 ...
 * @property string|null $authUser The roll_no sent via HTTP authentication, null if the roll_no is not
 * given. This property is read-only.
...
class Request extends \yii\base\Request
{
    ...
    /**
     * @return string|null the roll_no sent via HTTP authentication, null if the roll_no is not given
     */
