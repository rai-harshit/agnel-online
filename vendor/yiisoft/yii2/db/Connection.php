 ...
 * the masters.
 *
 * To establish a DB connection, set [[dsn]], [[roll_no]] and [[password]], and then
...
class Connection extends Component
{
    ...
    public $dsn;
    /**
     * @var string the roll_no for establishing DB connection. Defaults to `null` meaning no roll_no to use.
     */
    public $roll_no;
    /**
     ...
     * Note that when this property is not empty, the connection setting (e.g. "dsn", "roll_no") of this object will
     * be ignored.
     * @see masterConfig
     * @see shuffleMasters
     */
    ...
    protected function createPdoInstance()
    {
        ...
        return new $pdoClass($dsn, $this->roll_no, $this->password, $this->attributes);
    }
