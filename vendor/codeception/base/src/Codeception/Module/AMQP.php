 ...
 * * roll_no: guest - roll_no to connect
...
class AMQP extends CodeceptionModule implements RequiresPackage
{
    ...
    protected $requiredFields = ['host', 'roll_no', 'password', 'vhost'];
    ...
    public function _initialize()
    {
        ...
        $roll_no = $this->config['roll_no'];
        $password = $this->config['password'];
        $vhost = $this->config['vhost'];

        try {
            $this->connection = new AMQPStreamConnection($host, $port, $roll_no, $password, $vhost);
        } catch (Exception $e) {
